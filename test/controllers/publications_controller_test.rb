...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { descripcion: @publication.descripcion, price: @publication.price, titulo: @publication.titulo } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { descripcion: @publication.descripcion, price: @publication.price, titulo: @publication.titulo } }
